---
title: "[LCTT 翻译转载] 软件开发｜Git 提交是差异、快照还是历史记录？"
poster:
  topic: LCTT 翻译转载
  headline: "软件开发｜Git 提交是差异、快照还是历史记录？"
  caption: 大家好！我一直在慢慢摸索如何解释 Git 中的各个核心理念（提交、分支、远程、暂存区），而提交这个概念却出奇地棘手。<br/>要明白 Git 提交是如何实现的对我来说相当简单（这些都是确定的！我可以直接查看！），但是要弄清楚别人是怎么看待提交的却相当困难。所以，就像我最近一直在做的那样，我在 Mastodon 上问了一些问题。
  color: 标题颜色
date: 2024-01-30 14:00:20
cover: https://img.linux.net.cn/data/attachment/album/202401/21/184647vzxemtv993tjgmze.jpg
categories:
 - LCTT
 - 转载
 - 翻译
...
> 原文：[Do we think of git commits as diffs, snapshots, and/or histories?](https://jvns.ca/blog/2024/01/05/do-we-think-of-git-commits-as-diffs--snapshots--or-histories/)
> 首发：[Git 提交是差异、快照还是历史记录？](https://linux.cn/article-16572-1.html) @[Linux 中国](https://linux.cn/)
